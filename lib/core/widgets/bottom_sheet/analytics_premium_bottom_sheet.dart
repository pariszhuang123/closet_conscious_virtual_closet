...
class PremiumAnalyticsBottomSheet extends StatefulWidget {
  final bool isFromMyCloset;

  const PremiumAnalyticsBottomSheet({super.key, required this.isFromMyCloset});

  @override
  PremiumAnalyticsBottomSheetState createState() => PremiumAnalyticsBottomSheetState();
}

class PremiumAnalyticsBottomSheetState extends State<PremiumAnalyticsBottomSheet> {
  bool _isButtonDisabled = false;
  final logger = CustomLogger('AnalyticsRequest');
  ...
  Future<void> _handleButtonPress() async {
    ...
    try {
      final response = await Supabase.instance.client.rpc('increment_analytics_request').single();
