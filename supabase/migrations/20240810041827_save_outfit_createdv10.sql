...
BEGIN
    ...
    SET
        ...
        no_buy_highest_streak = CASE WHEN daily_upload_status IS FALSE AND has_closet_uploaded THEN GREATEST(no_buy_highest_streak + 1, no_buy_highest_streak) ELSE no_buy_highest_streak END,
        daily_upload = TRUE,
        updated_at = NOW()
