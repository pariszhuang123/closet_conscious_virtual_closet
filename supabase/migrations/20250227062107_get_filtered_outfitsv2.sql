...
BEGIN
    ...
    GROUP BY tfo.outfit_id, tfo.outfit_image_url, tfo.is_active  -- ✅ Grouping required columns
    ORDER BY tfo.is_active DESC, tfo.outfit_id  -- ✅ No more aggregation issues
