...
COMMENT ON COLUMN public.shared_preferences.item_name_filtered IS 'Indicates whether the item name should be excluded from filters. Default is TRUE, meaning item name filtering is typically not active unless set to FALSE.';
