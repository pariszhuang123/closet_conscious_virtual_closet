...
BEGIN
    ...
    SET
        ...
        highest_no_buy_streak = CASE WHEN daily_upload_status IS FALSE AND has_closet_uploaded THEN GREATEST(no_buy_streak + 1, highest_no_buy_streak) ELSE highest_no_buy_streak END,
        daily_upload = TRUE,
        updated_at = NOW()
