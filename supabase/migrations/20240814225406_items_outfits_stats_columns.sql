...
ALTER TABLE public.outfits ALTER COLUMN outfits_image_url SET NOT NULL DEFAULT 'cc_none';
...
-- Add the 'outfits_comments' column to outfits
ALTER TABLE public.outfits ADD COLUMN outfits_comments TEXT NOT NULL DEFAULT 'cc_none';
COMMENT ON COLUMN public.outfits.outfits_comments IS 'User comments on the outfit they have worn. If cc_none, means that the user did not insert comments.';