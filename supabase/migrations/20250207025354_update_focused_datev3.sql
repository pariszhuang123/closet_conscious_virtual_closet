...
BEGIN
    ...
    WHERE o.outfit_id = update_focused_date.outfit_id -- Explicitly reference the function parameter
    AND o.user_id = current_user_id
    AND sp.outfit_id = o.outfit_id -- Explicitly reference the table column
