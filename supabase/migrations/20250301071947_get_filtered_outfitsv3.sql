...
BEGIN
    ...
    -- 2) Create temporary table for filtered outfits
    ...
    -- 3) Outfits exist after filtering, so return the actual paginated list
    ...
    GROUP BY tfo.outfit_id, tfo.outfit_image_url, tfo.is_active
